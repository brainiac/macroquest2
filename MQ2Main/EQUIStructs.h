...
// actual size 0x1F0 in Jan 17 2017 Live (see 0x68CAA8) - eqmule
#define CXW_NO_VTABLE \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0020*/ RECT		ClipRectClient; \
/*0x0030*/ LONG		BlinkStartTimer; \
/*0x0034*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0038*/ int		VScrollPos; \
/*0x003C*/ bool		bMaximized; \
/*0x0040*/ UINT		TransitionStartTick; \
/*0x0044*/ int		DeleteCount; \
/*0x0048*/ bool		bTopAnchoredToTop; \
/*0x004C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0050*/ RECT		Location; \
/*0x0060*/ DWORD	XMLIndex; \
/*0x0064*/ bool		bActive; \
/*0x0068*/ void		*pLayoutStrategy; \
/*0x006C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0070*/ bool		Minimized; \
/*0x0074*/ COLORREF DisabledBackground; \
/*0x0078*/ bool		bLeftAnchoredToLeft; \
/*0x0079*/ bool		bAction; \
/*0x007C*/ DWORD	FadeDelay; \
/*0x0080*/ int		managerArrayIndex; \
/*0x0084*/ bool		bBottomAnchoredToTop; \
/*0x0088*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x008C*/ int		HScrollMax; \
/*0x0090*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0091*/ BYTE		StartAlpha; \
/*0x0092*/ bool		bTiled; \
/*0x0094*/ int		HScrollPos; \
/*0x0098*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x009C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00A0*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00A4*/ tagSIZE	MaxClientSize; \
/*0x00AC*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00B0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00B4*/ RECT		ClientRect; \
/*0x00C4*/ BYTE		Alpha; \
/*0x00C8*/ DWORD	LastTimeMouseOver; \
/*0x00CC*/ bool		bIsParentOrContextMenuWindow; \
/*0x00CD*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00CE*/ bool		bMarkedForDelete; \
/*0x00CF*/ bool		bBringToTopWhenClicked; \
/*0x00D0*/ RECT		TransitionRect; \
/*0x00E0*/ bool		Faded; \
/*0x00E4*/ void *pController; \
/*0x00E8*/ struct _CXSTR*	DataStr; \
/*0x00EC*/ bool		Enabled; \
/*0x00F0*/ DWORD  BackgroundDrawType; \
/*0x00F8*/ __int64		Data; \
/*0x0100*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0101*/ bool		bFullyScreenClipped; \
/*0x0104*/ int		BottomOffset; \
/*0x0108*/ tagSIZE	MinClientSize; \
/*0x0110*/ UINT		BlinkFadeStartTime; \
/*0x0114*/ void*	pTextObject; \
/*0x0118*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0119*/ bool		bEscapableLocked; \
/*0x011C*/ int		LeftOffset; \
/*0x0120*/ bool		Fades; \
/*0x0121*/ bool		bRightAnchoredToLeft; \
/*0x0124*/ UINT		FadeDuration; \
/*0x0128*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0129*/ bool		bScreenClipRectChanged; \
/*0x012C*/ RECT		ClipRectScreen; \
/*0x013C*/ void* pTipTextObject; \
/*0x0140*/ bool		bClientClipRectChanged; \
/*0x0141*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0142*/ bool		bMaximizable; \
/*0x0144*/ RECT		IconRect; \
/*0x0154*/ BYTE     bResizableMask; \
/*0x0158*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x015C*/ bool		bCaptureTitle; \
/*0x0160*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0164*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0168*/ void   *TitlePiece2; \
/*0x016C*/ void	*IconTextureAnim; \
/*0x0170*/ UINT		BlinkFadeFreq; \
/*0x0174*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0178*/ bool		bUseInLayoutHorizontal; \
/*0x017C*/ int		RightOffset; \
/*0x0180*/ BYTE		FadeAlpha; \
/*0x0181*/ bool		bClipToParent; \
/*0x0182*/ bool		bKeepOnScreen; \
/*0x0184*/ int		BlinkState; \
/*0x0188*/ bool		bIsTransitioning; \
/*0x018C*/ RECT		OldLocation; \
/*0x019C*/ UINT		BlinkFadeDuration; \
/*0x01A0*/ int		VScrollMax; \
/*0x01A4*/ ArrayClass2_RO<UINT> RuntimeTypes; \
/*0x01C0*/ bool		bUseInLayoutVertical; \
/*0x01C1*/ bool		bClientRectChanged; \
/*0x01C4*/ int		TopOffset; \
/*0x01C8*/ int		BlinkDuration; \
/*0x01CC*/ void	    *pFont; \
/*0x01D0*/ UINT		TransitionDuration; \
/*0x01D4*/ bool		dShow; \
/*0x01D8*/ void   *TitlePiece; \
/*0x01DC*/ int		ParentAndContextMenuArrayIndex; \
/*0x01E0*/ int	Transition; \
/*0x01E4*/ bool		bHCenterTooltip; \
/*0x01E5*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01E6*/ BYTE		TargetAlpha; \
/*0x01E7*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01E8*/ void	*DrawTemplate; \
/*0x01Ec*/ int		FillerNotSureWhy;
/*0x01f0*/
...
//Size is 0x45 see 68AB32 in Jan 17 2017 live exe -eqmule
enum ChatFilterEnum {
	CHAT_FILTER_SAY,
	CHAT_FILTER_TELL,
	CHAT_FILTER_GROUP,
...
// 10-27-2003 Lax
//Size 0x348 see 68A75F in 10 Jan 2017 Test exe -eqmule
...
/*0x24c*/ CHAR TellTarget[0x40];
/*0x28c*/ int Language;
/*0x290*/ bool bIsMainChat;
/*0x291*/ bool bIsTellWnd;
/*0x294*/ struct _CXSTR *CommandHistory[0x28]; // ->0x198
/*0x334*/ int HistoryIndex;
/*0x338*/ int HistoryLastShown;
/*0x33c*/ int FontSize;//style but yeah...
/*0x340*/ int AlwaysChathereIndex;//menu
/*0x344*/ int DontKnow;
/*0x348*/
...
//Jan 17 Live 2017 see 79F722 - eqmule
...
// Actual Size: 0x92d8 (see 4BCA2F) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x2f0 (see 4BC2CD) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x8d0 (see 4BC160) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x720 (see 4BBFF4) in Jan 17 2017 Live - eqmule
...
// Individual Gems 
// Actual Size: 0x320 (see 790348) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x2d0 (see 4BC3DE) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x618 (see 6DA9CF) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x3a0 (see 4BC7A0) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x658 (see 4BBE55) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x2d8 (see 4BC91E) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x8d0 (see 4BB890) in Jan 17 2017 Live - eqmule
...
//aClasscolorD
// Actual Size: 0x3b0 (see 4BBB83) in Jan 17 2017 Live - eqmule
...
// Actual Size: 0x2f8 (see 4BC979) in Jan 17 2017 Live - eqmule
